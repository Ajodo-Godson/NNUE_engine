import chess
from utils.constants import NUM_SQUARES, PROMOTION_PIECES, NUM_PROMOTIONS
...
def move_to_index(move):
    ...
    promotion_index = PROMOTION_PIECES.index(promotion_piece) if promotion_piece else 0
    index = (
